...
YC_DP_SSH_PUBLIC_KEY = 'YOUR_SSH_KEY'
YC_DP_SUBNET_ID = 'YOUR_SUBNET_ID'
YC_DP_SA_ID = 'YOUR_SA_ID'
YC_DP_METASTORE_URI = '10.128.0.20'
YC_BUCKET = 'etl-final-task2'
...
poke_spark_processing = DataprocCreatePysparkJobOperator(
    ...
    main_python_file_uri=f's3a://{YC_BUCKET}/scripts/convert.py',
)
